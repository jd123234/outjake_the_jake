  ...
  return (
    <div className="flex flex-col h-full mobile-container">
      ...
      {step === 'ranking' ? (
        ...
        <div className="flex-1 flex flex-col gap-1 overflow-y-auto px-2 pb-2">
          <div 
            ref={containerRef}
            className="clean-card flex-1 px-4 py-3 flex flex-col gap-3 scroll-container pb-9"
          >
        ...
        <div className="flex-1 flex flex-col gap-2 overflow-hidden px-2">
          <div className="clean-card flex-1 px-3 py-2 flex flex-col gap-2 overflow-y-auto pb-9">
