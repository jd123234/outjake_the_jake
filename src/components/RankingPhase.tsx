    ...
    <div className="flex flex-col h-full mobile-container">
      ...
      {step === 'ranking' ? (
        ...
        <div className="flex-1 flex flex-col gap-2 px-2">
          <div 
            ref={containerRef}
            className="clean-card overflow-y-auto px-4 py-3 flex flex-col gap-3 scroll-container pb-9"
          >
        ...
        /* Double Down Step */
        <div className="flex-1 flex flex-col gap-2 px-2">
          <div className="clean-card overflow-y-auto px-3 py-2 flex flex-col gap-2 pb-9">
